...
export const stats = [
  ...
  },
  {
    ...
    label: "Satisfaction",
    icon: FaHeart,
    gradient: "from-rose-500 via-teal-500 to-yellow-500",
  },
  {
    number: "500+",
    label: "Cities",
    icon: FaLeaf,
    gradient: "from-emerald-500 via-teal-500 to-yellow-600",
  },
  {
    number: "24/7",
    label: "Support",
...
export const inputBase =
  "w-full rounded-lg bg-[#0F172A] text-teal-100 placeholder-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-600";
export const iconClass =
  "absolute top-1/2 transform -translate-y-1/2 left-3 text-teal-400";
