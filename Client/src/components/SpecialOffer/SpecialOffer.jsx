      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 flex justify-center">
          <button
            ...
            className="flex items-center gap-3 bg-linear-to-r from-slate-700 to-teal-700 text-white px-8 py-4 rounded-2xl font-bold text-lg uppercase tracking-wider hover:gap-4 hover:scale-105 hover:shadow-xl hover:shadow-teal-500/20 transition-all duration-300 group border-2 border-teal-400/30 relative overflow-hidden cursor-pointer"
          >
            <div className="absolute inset-0 bg-linear-to-r fill-teal-500/20 via-transparent to-teal-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            <FaFire className="text-xl animate-pulse" />
            <span>{showAll ? "Show Less" : "Show More"}</span>
            <div className="h-full w-1 bg-teal-400/30 absolute right-0 top-0 group-hover:animate-border-pulse" />
          </button>
        </div>
      </div>
    </div>
