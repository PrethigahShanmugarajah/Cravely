      ...
      <div className="bg-white p-6 rounded-md w-96 relative shadow-lg">
        ...
        <div className="text-center mt-4">
          ...
          <div className="flex justify-center mt-4 gap-2">
            <button
              onClick={onClose}
              className="px-6 py-2 border border-gray-300 hover:bg-gray-100 rounded-md transition-all cursor-pointer hover:rounded-full"
            >
              Cancel
            </button>

            <button
              className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md transition-all cursor-pointer hover:rounded-full"
              disabled={loading}
              onClick={onDelete}
            >
